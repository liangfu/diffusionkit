# -*- coding: utf-8 -*-
#
# diffusionkit documentation build configuration file, created by
...
copyright = u'2012-2016, Brainnetome Center, CASIA'
...
htmlhelp_basename = 'diffusionkitdoc'
